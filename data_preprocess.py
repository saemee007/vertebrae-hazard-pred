...
if __name__ == "__main__":
    ...
    if True:
        ...
        os.system(f"python v7_2d_unet/inference.py --data_root {args.data_root} --gpu_id {args.gpu_id} --file_type {args.file_type} --config v7_2d_unet/configs/infer_config.yaml")
